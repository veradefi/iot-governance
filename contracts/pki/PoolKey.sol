...
contract PoolKey is Key, Whitelisted 
{
    ...
    function PoolKey(SmartKey _smartKey, address _poolVault, address _beneficiary, uint256 _max_contrib, uint256 _max_per_contrib, uint256 _min_per_contrib, address[] _admins, bool _has_whitelist, uint256 _fee, bool _autoDistribute) 
    Whitelisted(_admins, _admins) 
    Key(_smartKey, _beneficiary) 
    public
    {
