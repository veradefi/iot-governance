...
public:
    ...
    catalogue( eosio::name receiver, eosio::name code, eosio::datastream<const char*> ds ): eosio::contract(receiver, code, ds),  _polls(receiver, code.value), _votes(receiver, code.value), _catalogueTable(receiver, code.value), _metaTable(receiver, code.value)
    {}
    ...
    typedef eosio::multi_index
            <
                ...
                eosio::indexed_by<
                    ...
                    <
                        graph, uint64_t, &graph::by_hrefId
                    >
                >
            > catalogueTable;
