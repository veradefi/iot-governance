...
address4='0x5c6a178D57454536D269fc81DCF31d274E75E060'
address3='0x3f4BC017C2aC1766F98073F50B4fA9423a3e916f'
...
bal=web3.eth.getBalance(poolkey)
print ('getBalance (eth) for pool address',bal)
print ('distribute',pk.transact({ 'from': address}).distributeEth(bal))